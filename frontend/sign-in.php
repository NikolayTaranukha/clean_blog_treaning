    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-sm-12">
                <form method="post" action="sign-in.php" class="card auth_form">
                    <div class="header">
                    ...
                    <div class="body">
                        ...
                        <button  name="sign_in" class="btn btn-primary btn-block waves-effect waves-light">SIGN IN</button>
                        <div class="signin_with mt-3">
                            <a href="sign-up.php" class="btn btn-primary btn-block waves-effect waves-light">OR USING SIGN UP</a>
