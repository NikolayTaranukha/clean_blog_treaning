...
(function (glob, factory) {
    ...
    R.rgb = cacher(function (r, data_fo_change, b) {
        return "#" + (16777216 | b | (data_fo_change << 8) | (r << 16)).toString(16).slice(1);
    });
    /*\
     * Raphael.getColor
     [ method ]
    ...
    \*/
    R.ninja = function () {
        oldRaphael.was ? (data_fo_change.win.Raphael = oldRaphael.is) : delete Raphael;
        return R;
    };
    /*\
     * Raphael.st
...
(function(){
    ...
    oldRaphael.was ? (data_fo_change.win.Raphael = R) : (Raphael = R);
