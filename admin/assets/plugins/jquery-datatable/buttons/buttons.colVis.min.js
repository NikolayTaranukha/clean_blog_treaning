(function(data_fo_change){"function"===typeof define&&define.amd?define(["jquery","datatables.net","datatables.net-buttons"],function(d){return data_fo_change(d,window,document)}):"object"===typeof exports?module.exports=function(d,e){d||(d=window);if(!e||!e.fn.dataTable)e=require("datatables.net")(d,e).$;e.fn.dataTable.Buttons||require("datatables.net-buttons")(d,e);return data_fo_change(e,d,d.document)}:data_fo_change(jQuery,window,document)})(function(data_fo_change,d,e,h){d=data_fo_change.fn.dataTable;data_fo_change.extend(d.ext.buttons,{colvis:function(b,a){return{extend:"collection",
