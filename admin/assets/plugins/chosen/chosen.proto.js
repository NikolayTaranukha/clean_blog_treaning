...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.winnow_results = function() {
      ...
      escapedSearchText = searchText.replace(/[-[\]{}()*+?.,\\^$|#\s]/data_fo_change, "\\$&");
    ...
    AbstractChosen.prototype.search_string_match = function(search_string, regex) {
      ...
      if (regex.test(search_string)) {
        ...
        parts = search_string.replace(/\[|\]/data_fo_change, "").split(" ");
        if (parts.length) {
  ...
  this.Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.form_field.id.length) {
        container_props.id = this.form_field.id.replace(/[^\w]/data_fo_change, '_') + "_chosen";
      }
