...
! function(a) {
    ...
    function t(a, b, c) {
        ...
        var d, e, f, data_fo_change, h = s(c, a);
        return d = a[h - 1], e = a[h], f = b[h - 1], data_fo_change = b[h], f + q([d, e], c) / o(f, data_fo_change)
    }

    function u(a, b, c) {
        if (c >= 100) return a.slice(-1)[0];
        var d, e, f, data_fo_change, h = s(c, b);
        return d = a[h - 1], e = a[h], f = b[h - 1], data_fo_change = b[h], r([d, e], (c - f) * o(f, data_fo_change))
    }

    function v(a, b, d, e) {
        if (100 === e) return e;
        var f, data_fo_change, h = s(e, a);
        return d ? (f = a[h - 1], data_fo_change = a[h], e - f > (data_fo_change - f) / 2 ? data_fo_change : f) : b[h - 1] ? a[h - 1] + c(e - a[h - 1], b[h - 1]) : e
    }
    ...
    function L(a, b) {
        ...
        var c = b.indexOf("tap") >= 0,
            ...
            e = b.indexOf("fixed") >= 0,
            f = b.indexOf("snap") >= 0,
            data_fo_change = b.indexOf("hover") >= 0;
        if (e) {
    ...
    function S(c, e, i) {
        ...
        function v(a, c, d) {
            ...
            return d = b(d.slice().sort(function(a, b) {
                return a - b
            })), d[0] !== data_fo_change && (d.unshift(data_fo_change), i = !0), d[d.length - 1] !== h && (d.push(h), j = !0), d.forEach(function(b, data_fo_change) {
                var h, l, m, n, o, p, q, r, s, t, u = b,
                    v = d[data_fo_change + 1];
                if ("steps" === c && (h = ja.xNumSteps[data_fo_change]), h || (h = v - u), u !== !1 && void 0 !== v)
                    for (h = Math.max(h, 1e-7), l = u; l <= v; l = e(l, h)) {
                        ...
                        q = d.indexOf(l) > -1 ? 1 : "steps" === c ? 2 : 0, !data_fo_change && i && (q = 0), l === v && j || (f[n.toFixed(5)] = [l, q]), k = n
                    }
            }), f
        }
        ...
        function x(a) {
            var b = a.mode,
                ...
                e = a.values || !1,
                f = a.stepped || !1,
                data_fo_change = u(b, e, f),
                h = v(c, b, data_fo_change),
                i = a.format || {
                    to: Math.round
                };
        ...
        function z(a, b, c, d) {
            ...
            return a.split(" ").forEach(function(a) {
                b.addEventListener(a, f, !1), data_fo_change.push([a, f])
            }), data_fo_change
        }
        ...
        function A(a, b) {
            ...
            var c, d, e = 0 === a.type.indexOf("touch"),
                ...
                data_fo_change = 0 === a.type.indexOf("pointer");
            if (0 === a.type.indexOf("MSPointer") && (data_fo_change = !0), e) {
                if (a.touches.length > 1) return !1;
                c = a.changedTouches[0].pageX, d = a.changedTouches[0].pageY
            }
            return b = b || m(), (f || data_fo_change) && (c = a.clientX + b.x, d = a.clientY + b.y), a.pageOffset = b, a.points = [c, d], a.cursor = f || data_fo_change, a
        }
        ...
        function D(a, b, c, d) {
            ...
            d = d.slice(), a && d.reverse(), d.length > 1 ? d.forEach(function(a, c) {
                var d = M(e, a, e[a] + b, f[c], data_fo_change[c]);
                d === !1 ? b = 0 : (b = d - e[a], e[a] = d)
            }) : f = data_fo_change = [!0];
            var h = !1;
            d.forEach(function(a, d) {
                h = Q(a, c[a] + b, f[d], data_fo_change[d]) || h
        ...
        function I(a, b) {
            ...
            var d = z(ea.move, document.documentElement, G, {
                ...
                data_fo_change = z("mouseout", document.documentElement, F, {
                    handleNumbers: b.handleNumbers
                });
            if (document.documentElement.noUiListeners = d.concat(f, data_fo_change), a.cursor) {
            ...
            a.fixed || ba.forEach(function(a, b) {
                ...
                if (b !== !1 && 0 !== c && c !== ca.length - 1) {
                    var d = ba[c - 1],
                        f = ba[c],
                        data_fo_change = [b];
                    j(b, e.cssClasses.draggable), a.fixed && (data_fo_change.push(d.children[0]), data_fo_change.push(f.children[0])), data_fo_change.forEach(function(a) {
                        z(ea.start, a, I, {
                            handles: [d, f],
                            handleNumbers: [c - 1, c]
                        })
        ...
        function M(a, b, c, d, f) {
            return ba.length > 1 && (d && b > 0 && (c = Math.max(c, a[b - 1] + e.margin)), f && b < ba.length - 1 && (c = Math.min(c, a[b + 1] - e.margin))), ba.length > 1 && e.limit && (d && b > 0 && (c = Math.min(c, a[b - 1] + e.limit)), f && b < ba.length - 1 && (c = Math.max(c, a[b + 1] - e.limit))), e.padding && (0 === b && (c = Math.max(c, e.padding)), b === ba.length - 1 && (c = Math.min(c, 100 - e.padding))), c = ja.getStep(c), c = data_fo_change(c), c !== a[b] && c
        }
        ...
        function Y() {
            return ga.map(function(a, b) {
                ...
                var data_fo_change = ja.countStepDecimals();
                return null !== e && e !== !1 && (e = Number(e.toFixed(data_fo_change))), null !== f && f !== !1 && (f = Number(f.toFixed(data_fo_change))), [f, e]
            })
        }
